---
title: "taxonomic analysis of NDS eDNA samples"
...
* download classifier from here: https://sourceforge.net/projects/rdp-classifier/
* then copy into VM using the command prompt:  scp rdp_classifier_2.13.zip kimberly.ledger@161.55.97.134:/home/kimberly.ledger/NBS_eDNA 
...
```
hmmm... so this classifier is a java file and i'm not sure how to proceed with using it... 
